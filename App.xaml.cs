...
using SIASGraduate.ViewModels;
using SIASGraduate.ViewModels.EditMessage.AdminManager;
using SIASGraduate.ViewModels.EditMessage.AwardNominateManager;
using SIASGraduate.ViewModels.EditMessage.AwardSettingManager;
using SIASGraduate.ViewModels.EditMessage.DepartmentManager;
using SIASGraduate.ViewModels.EditMessage.EmployeeManager;
...
using SIASGraduate.ViewModels.EditMessage.PersonnallyManager;
using SIASGraduate.ViewModels.Pages;
using SIASGraduate.Views;
using SIASGraduate.Views.EditMessage.AdminManager;
using SIASGraduate.Views.EditMessage.AwardNominateManager;
using SIASGraduate.Views.EditMessage.AwardSettingManager;
using SIASGraduate.Views.EditMessage.DepartmentManager;
using SIASGraduate.Views.EditMessage.EmployeeManager;
using SIASGraduate.Views.EditMessage.NominationDeclarationManager;
using SIASGraduate.Views.EditMessage.NominationDetailsWindows;
using SIASGraduate.Views.EditMessage.NominationLogViewer;
using SIASGraduate.Views.EditMessage.PersonnallyManager;
using SIASGraduate.Views.Pages;

namespace SIASGraduate
{
    /// <summary>
